...
<footer class=" bg-[#242424]">
    <div class="mx-auto w-full max-w-screen-xl">
        ...
        <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Freelancing</h2>
    ...
    <div class="px-4 py-6  md:flex md:items-center md:justify-between border-t-2">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center"> 
            <div>

            <a href='#'><img src={logo} alt="" className='w-[120px]'/></a>
