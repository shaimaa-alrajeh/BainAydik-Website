...
function FormAdd() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col mx-auto w-full px-10 min-[450px]:w-[80%] min-[600px]:w-[60%] min-[900px]:w-[80%] min-[900px]:flex min-[900px]:flex-col">
      <div className="mb-4">
