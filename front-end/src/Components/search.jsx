import React from 'react';
    ...
    const Search = () => {
    return (
        <div className=' sm:flex sm:justify-center mt-16 mr-20'>
        <form action="/search" className="max-w-[480px] w-full px-4 sm:items-center	">
            <div className="relative">
            <input
                type="text"
                name="q"
                className="w-full border h-12 shadow p-4 rounded-full dark:text-gray-800 dark:border-gray-700 dark:bg-gray-200"
                placeholder="search about something here..."
            />
            <button type="submit">
                <svg
