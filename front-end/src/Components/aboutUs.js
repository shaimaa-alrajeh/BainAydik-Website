...
// import WhiteFooter from "./white-footer"
import Group from '../Photo/Group.png';
import logo from '../Photo/logo.png';

function AboutUs(){
    return(
        <body className="font-sans antialiased text-white leading-normal tracking-wider bg-cover bg-[#242424] flex flex-col rounded-lg">
